    ...
    <div className="w-full max-w-md p-8 rounded-2xl bg-white/70 backdrop-blur-xl border border-border/40 shadow-2xl transition-all duration-300 hover:shadow-primary/5">
      <div className="text-center md:text-left mb-8">
        ...
        <p className="text-sm text-text-muted mt-2">
          Start planning unforgettable events. Register as a planner or vendor.
        </p>
      </div>
      ...
      <form onSubmit={handleSignup} className="space-y-5">
        <div className="flex flex-col gap-2">
          <Label.Root htmlFor="fullName" className="text-xs font-bold text-foreground/80 uppercase tracking-wide">
            Full Name
          </Label.Root>
      ...
      <p className="text-center text-sm text-text-muted mt-8">
        ...
        <Link href="/login" className="text-foreground font-semibold hover:text-primary hover:underline underline-offset-2 transition-colors">
          Log in
        </Link>
      </p>
    </div>
