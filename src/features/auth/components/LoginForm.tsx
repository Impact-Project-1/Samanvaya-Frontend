  ...
  return (
    <div className="w-full max-w-md p-8 rounded-2xl bg-white/70 backdrop-blur-xl border border-border/40 shadow-2xl transition-all duration-300 hover:shadow-primary/5">
      ...
      <div className="flex items-center gap-4 my-6">
        ...
        <span className="text-xs font-semibold text-disabled-text uppercase tracking-wider">
          OR
        </span>
        <Separator.Root className="flex-1 h-[1px] bg-border/60" decorative />
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center">
            ...
            <Link
              href="#"
              className="text-xs font-semibold text-text-muted hover:text-primary transition-colors underline underline-offset-2"
            >
              Forgot Password?
            </Link>
          </div>
      ...
      <p className="text-center text-sm text-text-muted mt-8">
        ...
        <Link
          href="/signup"
          className="text-foreground font-semibold hover:text-primary hover:underline underline-offset-2 transition-colors"
        >
          Sign up for free
        </Link>
      </p>
