...
export const VendorRegistrationSchema = z.object({
  ...
  about: z
    .string()
    .min(20, "Please describe your business"),
...
.refine(
  (data) => data.price_range_high >= data.price_range_low,
  {
...
export type VendorRegistrationFormData =
  z.infer<typeof VendorRegistrationSchema>;