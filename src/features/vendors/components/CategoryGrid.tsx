...
const categories = [
  {
    ...
    icon: Flower,
    value: "decor-design",
    bg: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&q=80&w=600",
  },
  {
    name: "Catering",
    icon: Utensils,
    value: "catering-food-service",
    bg: "https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&q=80&w=600",
  },
  {
    name: "Photography & Video",
    icon: Camera,
    value: "media-content",
    bg: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&q=80&w=600",
  },
  {
    name: "Entertainment",
    icon: Music,
    value: "entertainment",
    bg: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&q=80&w=600",
  },
  {
    name: "Venues",
    icon: Building,
    value: "venues",
    bg: "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&q=80&w=600",
  },
  {
    name: "Locations",
    icon: MapPin,
    value: "locations",
    bg: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&q=80&w=600",
  },
];
